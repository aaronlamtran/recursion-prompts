...
var sumBelow = function (n) {
  // base case is that n = 0 so we stop
  if (n === 0) {
    return 0;
  }
  // keep decrememnting n and pass n into sumBelow
  if (n > 0) {
...
var replaceKeysInObj = function (obj, oldKey, newKey) {
  // iterate through obj
  for (var prop in obj) {
    // if the current property is equal to the old property
    if (prop === oldKey) {
      // reassign the value of the new key to the OG value
      obj[newKey] = obj[prop]
      // delete old value
      delete obj[prop]
    }
    // base case
    // if key is part of the object
